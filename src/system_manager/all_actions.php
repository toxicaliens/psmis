        ...
        <div class="x_content">
          ...
          <div class="" role="tabpanel" data-example-id="togglable-tabs">
            <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
              <li role="presentation" class="active"><a href="#add_system_action" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Add System Action</a>
              </li>
              <li role="presentation" class=""><a href="#all_system_actions" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">All System Actions</a>
              </li>
            </ul>
